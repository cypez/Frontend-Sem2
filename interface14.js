  ...
  return (
    <div className="interface">
      ...
      <div className="overlap">
        ...
        <div className="text-wrapper-3">Account address: 0xA3f4...42b9</div>
      </div>
      ...
      <div className="frame-2">
        <div className="text-wrapper-5">Binance</div>
        <img className="image" alt="Image" src={image3} />
      </div>

      <div className="frame-3">
        <div className="text-wrapper-6">Coinbase</div>
        <img className="image-2" alt="Image" src={image4} />
      </div>

      <div className="frame-4">
        <div className="text-wrapper-7">Uniswap</div>
        <img className="image-3" alt="Image" src={image5} />
      </div>

      <div className="text-wrapper-8">Government services</div>
      <div className="text-wrapper-9">Crypto services</div>
